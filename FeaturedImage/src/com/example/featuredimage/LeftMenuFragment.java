...
//        }
        ...
        rightFragments.append(HOME_INDEX,
                ((MainActivity) getActivity()).getFriendsTimeLineFragment());
...
//                ((MainTimeLineActivity) getActivity()).getMyProfileFragment());
        ...
        layout.nickname.setText(/*GlobalContext.getInstance().getCurrentAccountName()*/ "arthinking");
...
//                break;
    ...
    */
    ...
    private void setTitle(int res) {
        ((MainActivity) getActivity()).setTitle(res);
    }
